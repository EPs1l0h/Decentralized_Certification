...
def read_ganache_accounts():
    ...
    with open('../ganache_output.txt', 'r', encoding='utf-8') as file:
        ...
        addr_lines = [line for line in lines if '(1000 ETH)' in line]
        key_lines = [line for line in lines if 'Private Keys' not in line and '0x' in line and '(1000 ETH)' not in line]
